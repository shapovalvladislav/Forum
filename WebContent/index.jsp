...
<body>
	...
	<c:set var="prevPage" scope="session"
	...
	<div id="main">
		...
		<c:if test="${ not empty sessionScope.loggedProfileId}">
			<c:if
				test="${not empty sessionScope.userRole && sessionScope.userRole=='admin' }">
		...
		<div id="content">
			<table border="1px" id="central_table" class="b5radius">
				...
				<c:forEach var="section" items="${ sections}">
					<tr>
						<td class="section_in_table"><a
							href="topics.jsp?id=${section.id }">${ section.name }</a>
							<p>
								Модератор: <a href="profile.jsp?id=${section.moderatorId }">${ section.moderatorNickName}</a>
							</p></td>
						...
						<td>
							<ul style="list-style: none">
								...
								<li><a href="profile.jsp?id=${section.userId }">${section.userName }</a>
									<a href=""><img src="images/icon_topic_latest.gif"></a></li>
							</ul>
						</td>
					</tr>
